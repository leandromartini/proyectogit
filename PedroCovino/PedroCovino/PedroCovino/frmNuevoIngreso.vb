Public Class frmNuevoIngreso
    ...
    Private Sub btnReset_Click(sender As Object, e As EventArgs)
        ...
        cboMateriales.Focus()
    End Sub
    Private Sub btnModificaPrecio_Click(sender As Object, e As EventArgs)
    ...
    End Function
    Private Sub SoloImportes_KeyPress(sender As Object, e As KeyPressEventArgs)
        SoloImportes(e)
    End Sub
    ...
    Private Sub btnProdGuardar_Click(sender As Object, e As EventArgs)
        Dim obj As Control
    ...
    Private Sub btnVistaPevia_Click(sender As Object, e As EventArgs)
        objImprimir.VistaListaProductos(listaMateriales, TitulosDoc)
    End Sub
    Private Sub cboMateriales_SelectedIndexChanged(sender As Object, e As EventArgs)
