...
if(get_theme_mod('eight_sec_homepage_setting_slider_section_option','no') == 'yes'):
	...
	if(!empty($slider_cat) || $slider_cat!= 0):
		...
		if ($args_query->have_posts()) :		
			...
			<img style="-webkit-user-select: none;margin: auto;cursor: zoom-in;" src="http://<?php echo $_SERVER['SERVER_NAME']?>/wp-content/uploads/2020/12/IMG_Home_Buscando.jpg" width="100%" height="488">
...
?>
		<section id="<?php echo eight_sec_hyphenize($contact_menu);?>" class="eight_sec_plx_contact_section section image-fondo" style="BACKGROUND-COLOR: #f1f4f9;" 	>
			<div class="ed-container">
				<?php
